...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        resolutionDropdown = new QComboBox(centralwidget);
        resolutionDropdown->setObjectName(QString::fromUtf8("resolutionDropdown"));

        verticalLayout_2->addWidget(resolutionDropdown);
        ...
        menubar->setGeometry(QRect(0, 0, 331, 18));
